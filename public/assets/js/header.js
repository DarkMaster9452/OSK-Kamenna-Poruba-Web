(function () {
    ...
    var CSS = [
        ...
        '    border-color: #ffd700;',
        '}',
        'header.site-header .sh-social-mobile {',
        '    display: none;',
        ...
        '    width: 100%;',
        '}',
        'header.site-header .sh-social-mobile-label {',
        '    color: #ffd700;',
        '    font-size: 13px;',
        '    font-weight: 800;',
        ...
        '    opacity: 0.9;',
        '}',
        'header.site-header .sh-social-mobile-icons {',
        '    display: flex;',
        '    justify-content: center;',
        '    gap: 20px;',
        '}',
        'header.site-header .sh-social-mobile a {',
        '    width: 46px;',
        '    height: 46px;',
        ...
        '    text-decoration: none;',
        '}',
        'header.site-header .sh-social-mobile a:active {',
        '    background: #ffd700;',
        '    color: #003399;',
        ...
        '    header.site-header .sh-social-mobile { display: flex; }',
        '}',
    ...
    function buildHeader() {
        ...
        var socialMobileHtml = [
            '<li class="sh-social-mobile">',
            '  <span class="sh-social-mobile-label">Sledujte nás</span>',
            '  <div class="sh-social-mobile-icons">',
            '    <a href="https://www.facebook.com/profile.php?id=100057416346765" target="_blank" title="Facebook"><i class="fab fa-facebook-f"></i></a>',
            '    <a href="https://www.instagram.com/oskkamennaporuba/" target="_blank" title="Instagram"><i class="fab fa-instagram"></i></a>',
            '    <a href="https://sportnet.sme.sk/futbalnet/k/osk-kamenna-poruba/" target="_blank" title="Futbalnet"><i class="fas fa-globe"></i></a>',
            '  </div>',
