(function () {
    ...
    var CSS = [
        ...
        '    header.site-header .sh-nav ul { gap: 10px 14px; font-size: 13px; }',
        '    header.site-header .sh-logo { font-size: 16px; margin-right: 15px; gap: 10px; }',
        '    header.site-header .sh-logo-img { width: 62px; height: 62px; }',
        '    header.site-header .sh-login-btn { padding: 8px 14px; font-size: 13px; max-width: 160px; }',
        '}',
